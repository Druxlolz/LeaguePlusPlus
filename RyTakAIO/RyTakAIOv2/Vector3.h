...
public:
	...
	{
		float deltaACy = y - Seg2Start.y;
		float deltaDCx = Seg2End.x - Seg2Start.x;
		float deltaACx = x - Seg2Start.x;
		float deltaDCy = Seg2End.y - Seg2Start.y;
		float deltaBAx = Seg1End.x - x;
		float deltaBAy = Seg1End.y - y;
