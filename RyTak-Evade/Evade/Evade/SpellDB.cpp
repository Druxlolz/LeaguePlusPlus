...
#pragma region Galio
	Spells.push_back(CreateSpell()->_ChampName("Galio")->_MenuName("GalioQ")->_SpellName("GalioResoluteSmite")->_DangerValue(2)->_MissileName("GalioResoluteSmite")->_Range(930)->_Radius(200)->_MissileSpeed(1300)->_Type(ST_Arc)->_CollisionObjects(kCollidesWithHeroes || kCollidesWithYasuoWall));
