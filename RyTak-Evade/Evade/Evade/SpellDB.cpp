...
#pragma region Diana
	...
	Spells.push_back(CreateSpell()->_ChampName("Diana")->_DangerValue(3)->_MenuName("DianaQArc")->_SpellName("DianaQArc")->_Range(850)->_MissileSpeed(1400)->_Type(ST_Arc)->_Radius(70)->_DontCross(true)->_MissileFromUnit(true)->_IsDangerous(true)->_TakeClosestPath(true)->_CollisionObjects(kCollidesWithHeroes | kCollidesWithYasuoWall));
...
#pragma region Galio
	...
	Spells.push_back(CreateSpell()->_ChampName("Galio")->_MenuName("GalioQArc")->_SpellName("GalioQArc")->_DangerValue(2)->_Slot(kSlotQ)->_Range(825)->_Radius(80)->_MissileSpeed(1600)->_Type(ST_Arc)->_DontCross(true)->_MultipleAngle(M_PI)->_MultipleNumber(2)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Graves
	...
	Spells.push_back(CreateSpell()->_ChampName("Graves")->_MenuName("GravesW")->_SpellName("GravesSmokeGrenade")->_MissileName("GravesSmokeGrenadeBoom")->_ToggleName("Graves_SmokeGrenade_.+_Team_(Green|Red)")->_MissileSpeed(1500)->_Slot(kSlotW)->_Range(950)->_Radius(250)->_Type(ST_Circle)->_DontCross(true)->_ExtraDuration(4250)->_CollisionObjects(kCollidesWithHeroes | kCollidesWithYasuoWall));
...
#pragma endregion Warwick

#pragma region Wukong
	Spells.push_back(CreateSpell()->_ChampName("MonkeyKing")->_MenuName("MonkeyKingR")->_SpellName("MonkeyKingSpinToWin")->_DangerValue(3)->_Delay(50)->_Slot(kSlotR)->_Type(ST_Circle)->_Radius(320)->_DontCross(true)->_MissileToUnit(true));
...
#pragma region Zyra
	...
	Spells.push_back(CreateSpell()->_ChampName("Zyra")->_DangerValue(5)->_MenuName("ZyraR")->_Slot(kSlotR)->_SpellName("ZyraR")->_Delay(2200)->_Type(ST_Circle)->_DontCross(true)->_Range(700)->_Radius(520)->_MissileSpeed(INT_MAX));
