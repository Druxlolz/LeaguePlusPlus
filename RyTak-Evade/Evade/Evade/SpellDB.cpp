...
#pragma region Ekko
	...
	Spells.push_back(CreateSpell()->_ChampName("Ekko")->_MenuName("EkkoW")->_MissileName("EkkoWMis")->_SpellName("EkkoW")->_DangerValue(3)->_Delay(2250)->_Slot(kSlotW)->_Range(20000)->_Radius(375)->_CanBeRemoved(false)->_ExtraDuration(1500)->_Type(ST_Circle)->_ExtraDelay(1050));
...
#pragma region Galio
	Spells.push_back(CreateSpell()->_ChampName("Galio")->_MenuName("GalioQCircle")->_SpellName("GalioQ")->_ExtraMissileNames("GalioArcArc")->_DangerValue(2)->_Range(825)->_Radius(200)->_MissileSpeed(1600)->_Type(ST_Circle)->_DontCross(true)->_ExtraDuration(1500)->_CollisionObjects(kCollidesWithYasuoWall));
...
#pragma region Jinx
	...
	Spells.push_back(CreateSpell()->_ChampName("Jinx")->_MenuName("JinxE")->_SpellName("JinxTrap")->_TrapName("jinxmine")->_Delay(0)->_IsDangerous(true)->_Slot(kSlotE)->_Type(ST_Circle)->_Radius(65)->_DontCross(true)->_ExtraDuration(5000)->_CanBeRemoved(true));
...
#pragma region Karma
	...
	Spells.push_back(CreateSpell()->_ChampName("Karma")->_MenuName("KarmaQMantra")->_SpellName("KarmaQMantra")->_DangerValue(2)->_MissileName("KarmaQMissileMantra")->_ToggleName("Karma_.+_Q_impact_R_01")->_MissileSpeed(1700)->_Range(950)->_Radius(80)->_ExtraDuration(1650)->_CanBeRemoved(true)->_FixedRange(true)->_HasEndExplosion(true)->_RadiusEx(280)->_CollisionObjects(kCollidesWithMinions | kCollidesWithHeroes | kCollidesWithYasuoWall));
...
#pragma region Nidalee
	...
	Spells.push_back(CreateSpell()->_ChampName("Nidalee")->_MenuName("NidaleeW")->_SpellName("Bushwhack")->_ToggleName("Nidalee_.+_W_TC_(Green|Red)")->_DangerValue(2)->_Type(ST_Circle)->_Radius(100)->_Range(900)->_IsDangerous(true)->_CanBeRemoved(true)->_ExtraDuration(120000));
...
#pragma region Veigar
	...
	Spells.push_back(CreateSpell()->_ChampName("Veigar")->_DangerValue(3)->_MenuName("VeigarE")->_SpellName("VeigarEventHorizon")->_Delay(800)->_RadiusEx(300)->_Slot(kSlotE)->_Type(ST_Ring)->_Range(700)->_Radius(390)->_DontCross(true)->_ExtraDuration(3000)->_IsDangerous(true));
